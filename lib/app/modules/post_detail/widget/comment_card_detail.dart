...
class CommentCardDetail extends StatefulWidget {
  final snap;
  final String postId;
  ...
  @override
  State<CommentCardDetail> createState() => _CommentCardDetailState();
}

class _CommentCardDetailState extends State<CommentCardDetail> {
