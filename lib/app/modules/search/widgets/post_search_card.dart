...
import 'package:unsikuy_app/app/modules/search/controllers/search_controller.dart';
...
class PostSearchCard extends StatefulWidget {
  final snap;
  final SearchController controller;
  PostSearchCard({super.key, required this.snap, required this.controller});

  @override
  State<PostSearchCard> createState() => _PostSearchCardState();
}

class _PostSearchCardState extends State<PostSearchCard> {
